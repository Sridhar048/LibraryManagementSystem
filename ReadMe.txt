Step 1: Double Click on MyLibraryTuto.sln
Step2 : In the shared folder, copy the database file called "Mylibrarydb.mdf" and paste it in your documents
...
SqlConnection Con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\afwadmin\Documents\Mylibrarydb.mdf;Integrated Security=True;Connect Timeout=30");
